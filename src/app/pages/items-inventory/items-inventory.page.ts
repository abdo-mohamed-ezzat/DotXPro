      ...
      this.subscriptions.push(
        this.apiService
          ...
          .subscribe({
            next: (report) => {
              this.itemsInverntoryReport = report;
              this.itemsInverntoryReport.forEach((account) => {
                this.totalStockQuantity += account.stockQuantity;
                this.totalStockUnitCost += account.stockUnitCost;
                this.totalStockTotalCost += account.stockTotalCost;
              });
              this.loading = false;
            },
            error: (err) => {
